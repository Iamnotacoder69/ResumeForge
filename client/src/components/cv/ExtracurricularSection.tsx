...
const ExtracurricularSection: React.FC<ExtracurricularSectionProps> = ({ form }) => {
  ...
  const handleEnhance = async (index: number) => {
    try {
      ...
      const currentDescription = form.getValues(`extracurricular.${index}.description`);
      ...
      <CardContent className="pt-5 sm:pt-6">
        ...
        {fields.length === 0 && (
          <div className="text-center text-gray-500 py-8">
            <p>No extracurricular activities added yet. Add your volunteering experience, projects, or other activities.</p>
          </div>
        )}
        ...
        {fields.map((field, index) => (
          <div 
            key={field.id} 
            className="activity-item border border-gray-200 rounded-md p-4 mb-6"
          >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Community Center, Student Club, etc." {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Volunteer, Team Lead, Member" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
